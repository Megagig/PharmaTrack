...
export function NotificationsPanel() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      id: '2',
      title: 'System Update',
      message: 'PharmaTrack will be undergoing maintenance on July 2nd from 2-4 AM.',
      date: '2023-06-25',
      read: false,
      type: 'info'
    },
            ...
            notifications.map((notification) => (
              <Paper 
                ...
                style={{ 
                  ...
                  borderLeft: `4px solid var(--mantine-color-${getNotificationColor(notification.type)}-filled)`
                }}
              >
                <Group justify="space-between" mb="xs">
                ...
                <Text size="sm" mb="xs">{notification.message}</Text>
                {!notification.read && (
                  <Button 
                    variant="subtle" 
                    size="xs" 
