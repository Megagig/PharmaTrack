...
export function LandingPage() {
  ...
  const testimonials = [
    {
      quote: "PharmaTrack has revolutionized how we manage our pharmacy data. The reporting process is now seamless and efficient.",
      author: "Dr. Sarah Johnson",
      position: "Chief Pharmacist, Community Health Center"
    },
    {
      quote: "The analytics provided by PharmaTrack have helped us identify trends and make better decisions for public health initiatives.",
      author: "Michael Chen",
      position: "Health Department Executive"
    },
    {
      quote: "Implementation was smooth and the support team was incredibly helpful. Our staff adapted to the system quickly.",
          ...
          <SimpleGrid cols={{ base: 1, md: 2 }} spacing={50}>
            <Box pt={20}>
              <Title order={1} size={rem(48)} fw={900} lh={1.1} mb={30}>
                ...
                <Text component="span" inherit variant="gradient" gradient={{ from: 'cyan', to: 'white' }}>
                  PharmaTrack
                </Text>
              </Title>
              <Text size="xl" mb={30}>
                A comprehensive solution for pharmacies and health executives to collect, analyze, and report critical pharmacy data.
              </Text>
              <Group>
                <Button component={Link} to="/register" size="lg" radius="md">
                  Get Started
                </Button>
                <Button component={Link} to="/features" size="lg" radius="md" variant="outline" color="white">
                  Learn More
                </Button>
              </Group>
            </Box>
        ...
        <Container size="lg">
          ...
          <SimpleGrid cols={{ base: 1, md: 3 }} spacing={30}>
            <Paper withBorder p="xl" radius="md" style={{ textAlign: 'center' }}>
              ...
              <Text size="sm" c="dimmed">
                Create an account and set up your pharmacy profile with all necessary details.
              </Text>
            </Paper>
            ...
            <Paper withBorder p="xl" radius="md" style={{ textAlign: 'center' }}>
              ...
              <Text size="sm" c="dimmed">
                Easily submit your monthly data through our intuitive reporting interface.
              </Text>
            </Paper>
            ...
            <Paper withBorder p="xl" radius="md" style={{ textAlign: 'center' }}>
              ...
              <Text size="sm" c="dimmed">
                Access analytics and insights to improve your pharmacy operations and compliance.
              </Text>
            </Paper>
          </SimpleGrid>
        </Container>
      ...
      <Container size="lg" py={80}>
        ...
        <SimpleGrid cols={{ base: 1, md: 3 }} spacing={30}>
          {testimonials.map((testimonial, index) => (
            <Paper key={index} withBorder p="xl" radius="md">
      ...
      >
        <Container size="md" ta="center">
          ...
          <Text size="xl" mb={30} maw={600} mx="auto">
            Join thousands of pharmacies nationwide who are streamlining their reporting and improving compliance with PharmaTrack.
          </Text>
          <Group justify="center">
            <Button component={Link} to="/register" size="lg" radius="md">
              Register Now
            </Button>
            <Button component={Link} to="/contact" size="lg" radius="md" variant="outline" color="white">
              Contact Sales
            </Button>
          </Group>
        </Container>
